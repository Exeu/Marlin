...
#define HOMING_BUMP_MM      { 0, 0 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
 ...
 * Probing Margins
 *
 * Override PROBING_MARGIN for each side of the build platex
 ...
 */
#define STARTUP_COMMANDS "M3 I S0.5"
